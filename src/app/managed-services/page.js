    ...
    <>
      ...
      <div style={{ padding: '0.5rem 0 5rem', background: 'var(--ink)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
          ...
          <Link href={`/managed-services/${featured.slug}`} className="svc" style={{ textDecoration: 'none', display: 'grid', gridTemplateColumns: '1fr 1fr', marginBottom: '1px', overflow: 'hidden' }}>
