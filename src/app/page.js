    ...
    <>
      ...
      <div className="split-section">
        ...
        <div className="split-right"><ScrollReveal>
          ...
          <p style={{ fontSize: '0.9rem', lineHeight: 1.85, color: 'var(--paper)', fontWeight: 600, marginBottom: '1.5rem', maxWidth: '420px' }}>Direct Placement of nursing professionals across North America. Partnered with Nersify — 300+ hospitals, 20,000+ professionals worldwide.</p>
