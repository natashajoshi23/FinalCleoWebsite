    ...
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '5rem', marginTop: '3.5rem' }}>
        ...
        <div className="cards-col">
          {[
            { num: '01', title: 'Who We Are', text: "We are Cleo Consulting, a hardworking and dedicated IT Consulting and Recruitment firm. Cleo is being built by partners who boast a combined experience of over 200+ years in IT Consulting and Recruitment Industry. Since Cleo's inception, we have partnered with multiple clients in various industries successfully delivering projects.", mobileText: "An IT Consulting & Recruitment firm built by partners with 200+ years of combined industry experience.", img: '/images/laptop-teamwork.webp' },
            { num: '02', title: 'What We Do', text: "We have strategic partnerships to deliver various consulting projects with both onshore and offshore delivery models. At the same time, our core business entails providing end to end recruitment services — IT, Finance & Accounting, Engineering, Customer Service, Admin Support and Sales. This allows our clients to focus on what is most important for their company while leaving their hiring needs to us.", mobileText: "We deliver IT consulting projects and end-to-end recruitment across IT, Finance, Engineering, and more — so you can focus on what matters.", img: '/images/desk-bw.webp' },
            { num: '03', title: 'Why Cleo?', text: "We are not a typical projects consulting firm — we serve a limited number of clients to build strong partner relationships. This allows us to deliver a higher level of responsiveness, fewer blocking restrictions, maximum access to the market and personal, partner-led involvement on all assignments. Being small allows us to stay hungry, remain motivated and driven to excel. We are of the \"Action Speaks Louder Than Words\" school of thought.", mobileText: "We serve a select number of clients to deliver partner-led, personal service. Small by choice — driven to excel.", img: '/images/puzzle-light.webp' },
          ].map(({ num, title, text, mobileText, img }, i) => (
            <ScrollReveal key={num} delay={i + 1}><div className="m-card">
              <div className="m-num">{num}</div>
              <div><div className="m-title">{title}</div><p className="m-text">{isMobile && mobileText ? mobileText : text}</p>
