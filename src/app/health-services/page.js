    ...
    <>
      ...
      <div style={{ maxWidth: '950px', margin: '0 auto', padding: '4rem 2rem 5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2.5rem', alignItems: 'center', marginBottom: '3rem' }}>
          ...
          <div>
            <div className="hs-label" style={{ fontFamily: 'var(--display)', fontSize: '1.1rem', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '1rem' }}>We offer nursing staff for these specialties:</div>
        ...
        <div style={{ padding: '2.5rem', border: '1px solid var(--ghost)', marginBottom: '3rem', position: 'relative' }}>
          <div className="hs-label" style={{ position: 'absolute', top: '-0.7rem', left: '1.5rem', background: 'var(--ink)', padding: '0 0.75rem', fontFamily: 'var(--display)', fontSize: '1.1rem', letterSpacing: '0.12em', textTransform: 'uppercase' }}>Partnership</div>
          ...
          <div style={{ display: 'flex', gap: '2rem', marginTop: '1.5rem', alignItems: 'center' }}>
            {[
              ...
              <div key={s.l}>
                <div className="hs-stat-n" style={{ fontFamily: 'var(--display)', fontSize: '2.2rem' }}>{s.n}</div>
        ...
        <div style={{ marginBottom: '3rem' }}>
          <h2 style={{ fontFamily: 'var(--display)', fontSize: '1.6rem', color: 'var(--paper)', letterSpacing: '0.04em', marginBottom: '1.5rem' }}>WHY PARTNER WITH CLEO</h2>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px', background: 'var(--ghost)' }}>
            {[
              ...
              <div key={t} style={{ background: 'var(--ink)', padding: '2rem' }}>
                <div className="hs-card-t" style={{ fontFamily: 'var(--display)', fontSize: '1rem', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '0.75rem', fontWeight: 700 }}>{t}</div>
