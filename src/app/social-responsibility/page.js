...
export default function CSR() {
  return (
    <>
      <link rel="preload" as="image" href="/images/puzzle-colorful.webp" />
      ...
      <div className="pg-body">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start', marginBottom: '3rem' }}>
          ...
          <div style={{ height: '320px', overflow: 'hidden', borderRadius: '2px' }} className="img-zoom"><img src="/images/puzzle-light.webp" alt="Puzzle" className="img-cover" width={900} height={224} loading="lazy" /></div>
        </div>
